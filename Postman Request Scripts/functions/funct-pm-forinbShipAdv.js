...
const prefix = "009"; 
const randomNumber = Math.floor(10000000000000000 + Math.random() * 90000000000000000); 
return prefix + randomNumber;
}
...
let addressName = pm.variables.replaceIn('{{$randomCompanyName}}'); //must use replaceIn because the xml iis already template literal 
